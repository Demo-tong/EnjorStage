        ...
        <div class="pui-layout pui-flex login-main">
            <div class="pui-layout pui-layout-fixed pui-layout-fixed-1200 login-main-con">
                <div class="login-panel">
                    <form id="login" name="login" class="pui-form login-form" action="${pageContext.request.contextPath }/user/loginRequest" method="post">
                        <div class="pui-form-group">
                            <h1 class="pui-text-white pui-text-normal">
                                <i class="fa fa-cart-arrow-down fa-2x pui-text-xxxxxxl"></i> 趣分期项目登录
                            </h1>
                        </div>
						...
						<div class="pui-form-group input_submit">
                                <button type="submit" id="submit" class="pui-btn pui-btn-default pui-btn-block pui-round">登录</button>
                        </div>
                    </form>
                </div>
            </div>
