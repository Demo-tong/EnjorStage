			...
			<div
				...
				<div class="login-panel">
					<form id="login" name="login" class="pui-form login-form"
						action="${pageContext.request.contextPath }/user/registRequest"
						method="post">
						...
						<div class="pui-form-group">
							<div role="sid">
								...
								<input type="text" name="username" class="pui-unbordered"
									...
									class="glyphicons glyphicons-user-add form-control-feedback"></i>
							</div>
						</div>
						...
						<div class="pui-form-group">
							<div role="password">
								<input type="password" name="password" maxlength="16"
									class="pui-unbordered" placeholder="您的密码" /> <i
						...
						<div class="pui-form-group">
							<div role="password">
								<input type="password" name="password_t" maxlength="16"
									class="pui-unbordered" placeholder="再次输入您的密码" /> <i
									class="glyphicon glyphicon-lock form-control-feedback"></i>
							</div>
						</div>
						...
						<div class="pui-form-group input_submit">
							<button type="submit" id="submit"
								class="pui-btn pui-btn-default pui-btn-block pui-round">注册</button>
						</div>
					</form>
				</div>
			</div>
